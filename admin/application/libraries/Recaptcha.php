...
class Recaptcha
{
    ...
    public function __construct()
    {
        ...
        $settings = get_general_settings(4);
        $recaptcha = [];
        foreach ($settings as $key => $value) {
           $recaptcha[$value['setting_name']]= $value['filed_value'];
        } 
        $this->_siteKey = $recaptcha['recaptcha_site_key'];
        $this->_secretKey = $recaptcha['recaptcha_secret_key'];
        $this->_language = $recaptcha['recaptcha_lang'];
    }
